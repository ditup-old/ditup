...
var dbData = require('./dbDataProjects');
...
describe('visiting /projects', function () {
//TODO user, project, project, project, discussion
  var server, browser;
  var browserObj = {};
  var serverObj = {};
...
//**************shared variables & functions
  ...
  testCollections('project', dbData, dependencies);
});
